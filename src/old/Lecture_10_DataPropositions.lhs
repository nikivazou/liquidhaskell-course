...
{-@ even_plus_2 :: n:{N | n /= Z} -> Prop (EVEN n) -> (m::N, {v:() | n == S (S m)}) @-}
even_plus_2 n E0       = error "impossible"
even_plus_2 n (E2 m e) = (m, ())

-- n:N -> Prop (EVEN n) -> Prop (EVEN (S (S n)))


even_plus :: N -> N -> EVEN -> EVEN -> EVEN 
{-@ even_plus :: n:N -> m:N -> Prop (EVEN n) -> Prop (EVEN m) -> Prop (EVEN (plus n m)) @-}
even_plus _ _ E0     e = e 
even_plus n m (E2 _ e) e' 
  = case n of 
       S (S n') -> E2 (plus n' m) (even_plus n' m e e')
