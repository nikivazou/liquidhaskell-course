...
_Hint:_ The step goes by induction on the list while the base case is trivial.
-}
...
[class](https://nikivazou.github.io/lh-course/Lecture_09_NaturalDeduction.html). 
...
$$ lp1  \doteq (p \land (q \lor r)) \Rightarrow ((p \land q) \lor (p \land r)) $$
-}
...
{-@ lp1 :: p:Bool -> q:Bool -> r:Bool 
   ...
   @-}
lp1 :: Bool -> Bool -> Bool -> (() , Either () ()) -> Either (() , ()) (() , ())
...
$$ lp2 \doteq (p \Rightarrow q) \Rightarrow \neg q \Rightarrow \neg p $$
-}
...
$$ lp3 \doteq ((\forall x. p\ x \Rightarrow q) \land \exists x.  p\ x) \Rightarrow q $$
-}

{-@ l2 :: p:(a -> Bool) -> q:Bool 
       -> ((x:a -> {v:() | p x} -> {v:() | q}), (x::a, {v:() | p x}))
       -> (x::a, {v:() | q}) @-}
l2 :: (a -> Bool) -> Bool -> (a -> () -> (), (a, ())) -> (a, ())
l2 _ _ _ = undefined
\end{code}